...
#经验值
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'金胡萝卜'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_jhlb",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'金剑'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_jinjian",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'铁剑'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_tiejian",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'钻石剑'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_zuanshijian",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'下界合金剑'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_xiajiehejinjian",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'铁斧'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_tiefu",name:"@s"},color:"red"}]
execute as @a[gamemode=adventure] if score system status matches 1..2 if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'钻石斧'}] run title @s actionbar [{translate: "game.ingame.shengji.general.1",color:"dark_green"},{score:{objective:"shengji_zuanshifu",name:"@s"},color:"red"}]
#
