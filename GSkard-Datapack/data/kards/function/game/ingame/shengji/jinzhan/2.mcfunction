...
execute if items entity @s weapon.mainhand *[custom_data={kards:'重锤'}] run item replace entity @s weapon.mainhand from block 5 -60 -48 container.25
...
execute if items entity @s weapon.mainhand *[custom_data={kards:'重锤'}] run scoreboard players set @s level_zhongchui 2
