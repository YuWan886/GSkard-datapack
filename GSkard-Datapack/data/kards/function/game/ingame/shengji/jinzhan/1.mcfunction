#0
execute if items entity @s weapon.mainhand *[custom_data={kards:'金胡萝卜'}] run item replace entity @s weapon.mainhand from block 5 -60 -48 container.9 kards:1shanghai
execute if items entity @s weapon.mainhand *[custom_data={kards:'金剑'}] run item replace entity @s weapon.mainhand from block 5 -60 -48 container.10 kards:1shanghai
execute if items entity @s weapon.mainhand *[custom_data={kards:'铁剑'}] run item replace entity @s weapon.mainhand from block 5 -60 -48 container.11 kards:2shanghai
execute if items entity @s weapon.mainhand *[custom_data={kards:'钻石剑'}] run item replace entity @s weapon.mainhand from block 5 -60 -48 container.12 kards:3shanghai
