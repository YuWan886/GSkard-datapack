...
execute if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'下界合金剑'}] run item modify entity @s weapon.mainhand kards:5shanghai
execute if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'重锤'}] run scoreboard players set @s level_zhongchui 6
execute if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'下界合金剑'}] run scoreboard players set @s level_xiajiehejinjian 6
execute if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'重锤'}] run item modify entity @s weapon.mainhand kards:8shanghai
execute if items entity @s weapon.mainhand #kards:jinzhanwuqi[custom_data={kards:'重锤'}] run enchant @s minecraft:density 5
