...
#无用
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'无用之基'}] if score @s kardCount >= #kard_wuyongjiben kardCount run function kards:game/yongpaiku/jiben/wuyongji
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'无用之法'}] if score @s kardCount >= #kard_wuyongfashu kardCount run function kards:game/yongpaiku/fashu/wuyongfa
execute if items entity @s weapon.offhand #kards:kard[custom_data~{kards:'无用之神'}] if score @s kardCount >= #kard_wuyongshenji kardCount run function kards:game/yongpaiku/shenji/wuyongshen
#再来一罐
