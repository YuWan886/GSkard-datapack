...
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'洗牌'}] if score @s kardCount >= #kard_xipai kardCount run function kards:game/yongpaiku/fashu/xipai
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'有偿借贷'}] if score @s kardCount >= #kard_youchangjiedai kardCount run function kards:game/yongpaiku/fashu/youchangjiedai
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'赌命'}] if score @s kardCount >= #kard_duming kardCount run function kards:game/yongpaiku/fashu/duming
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'黑山羊之拥'}] if score @s kardCount >= #kard_heishanyangzhiyong kardCount run function kards:game/yongpaiku/fashu/heishanyangzhiyong
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'盈余之力'}] if score @s kardCount >= #kard_yingyuzhili kardCount run function kards:game/yongpaiku/fashu/yingyuzhili
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'超脱洗礼'}] if score @s kardCount >= #kard_chaotuoxili kardCount run function kards:game/yongpaiku/fashu/chaotuoxili
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'预言灾祸'}] if score @s kardCount >= #kard_yuyanzaihuo kardCount run function kards:game/yongpaiku/fashu/yuyanzaihuo
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'重铸'}] if score @s kardCount >= #kard_chongzhu kardCount run function kards:game/yongpaiku/fashu/chongzhu
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'过河拆桥'}] if score @s kardCount >= #kard_guohechaiqiao kardCount run function kards:game/yongpaiku/fashu/guohechaiqiao/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'视角干扰'}] if score @s kardCount >= #kard_shijiaoganrao kardCount run function kards:game/yongpaiku/fashu/shijiaoganrao/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'宰鸡敬猴'}] if score @s kardCount >= #kard_zaijijinhou kardCount run function kards:game/yongpaiku/fashu/zaijijinhou
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'战时生产'}] if score @s kardCount >= #kard_zhanshishengchan kardCount run function kards:game/yongpaiku/fashu/zhanshishengchan
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'揭示'}] if score @s kardCount >= #kard_jieshi kardCount run function kards:game/yongpaiku/fashu/jieshi/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'水流涌动'}] if score @s kardCount >= #kard_shuiliuyongdong kardCount run function kards:game/yongpaiku/fashu/shuiliuyongdong
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'顺手牵羊'}] if score @s kardCount >= #kard_shunshouqianyang kardCount run function kards:game/yongpaiku/fashu/shunshouqianyang/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'闪电轰鸣'}] if score @s kardCount >= #kard_shandianhongming kardCount run function kards:game/yongpaiku/fashu/shandianhongming/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'劫掠'}] if score @s kardCount >= #kard_jielue kardCount run function kards:game/yongpaiku/fashu/jielue/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'禁字启封'}] if score @s kardCount >= #kard_jinziqifeng kardCount run function kards:game/yongpaiku/fashu/jinziqifeng
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'内核引爆'}] if score @s kardCount >= #kard_neiheyinbao kardCount run function kards:game/yongpaiku/fashu/neiheyinbao
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'背水一战'}] if score @s kardCount >= #kard_beishuiyizhan kardCount run function kards:game/yongpaiku/fashu/beishuiyizhan
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'石化皮肤'}] if score @s kardCount >= #kard_shihuapifu kardCount run function kards:game/yongpaiku/fashu/shihuapifu
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'生产令'}] if score @s kardCount >= #kard_shengchanling kardCount run function kards:game/yongpaiku/fashu/shengchanling
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'以智取胜'}] if score @s kardCount >= #kard_yizhiqusheng kardCount run function kards:game/yongpaiku/fashu/yizhiqusheng
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'整修'}] if score @s kardCount >= #kard_zhengxiu kardCount run function kards:game/yongpaiku/fashu/zhengxiu
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'紧急调遣'}] if score @s kardCount >= #kard_jinjidiaoqian kardCount run function kards:game/yongpaiku/fashu/jinjidiaoqian
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'漫水'}] if score @s kardCount >= #kard_manshui kardCount run function kards:game/yongpaiku/fashu/manshui/1
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'四季如春'}] if score @s kardCount >= #kard_sijiruchun kardCount run function kards:game/yongpaiku/fashu/sijiruchun
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'死刑宣告'}] if score @s kardCount >= #kard_sixingxuangao kardCount run function kards:game/yongpaiku/fashu/sixingxuangao
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'心灵焚烧'}] if score @s kardCount >= #kard_xinlingfenshao kardCount run function kards:game/yongpaiku/fashu/xinlingfenshao
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'起死回生'}] if score @s kardCount >= #kard_qisihuisheng kardCount run function kards:game/yongpaiku/fashu/qisihuisheng
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'春暖花开'}] if score @s kardCount >= #kard_chunnuanhuakai kardCount run function kards:game/yongpaiku/fashu/chunnuanhuakai
execute if items entity @s weapon.offhand #minecraft:creeper_drop_music_discs[custom_data={kards:'狼群战术'}] if score @s kardCount >= #kard_langqunzhanshu kardCount run function kards:game/yongpaiku/fashu/langqunzhanshu
