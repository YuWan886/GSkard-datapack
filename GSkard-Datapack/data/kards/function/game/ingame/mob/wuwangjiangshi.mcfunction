...
execute as @e[tag=wuwangjiangshi,team=red] at @s run effect give @e[distance=..5,team=red] speed 1 0 false
execute as @e[tag=wuwangjiangshi,team=blue] at @s run effect give @e[distance=..5,team=blue] speed 1 0 false
