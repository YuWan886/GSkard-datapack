...
execute if score #system worldborder matches 0 run title @a title {translate: "kards.function.game.ingame.round.pvpround.worldborder.1", fallback: "边界开始收缩!",color:"gray",bold:true}
