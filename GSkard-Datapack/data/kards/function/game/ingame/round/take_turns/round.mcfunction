...
#> buff生效
tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.2", fallback: "==========事件==========",color:"gray",bold:true}]
#重伤
scoreboard players remove @a[scores={ZhongShang_Round=1..}] ZhongShang_Round 1
execute if entity @a[scores={ZhongShang_Round=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.3", fallback: "[重伤]",color:"dark_gray",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.4", fallback: "生效至\n",color:"gray"},{selector:"@a[scores={ZhongShang_Round=1..}]",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.5", fallback: "\n他们本回合生命恢复效率减半",color:"gray",bold:true}]
execute if entity @a[scores={ZhongShang_Round=0}] run tellraw @a [{selector:"@a[scores={ZhongShang_Round=0}]",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.6", fallback: "脱离了",color:"gray",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.3", fallback: "[重伤]",color:"dark_gray",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.7", fallback: "状态",color:"gray"}]
execute if entity @a[scores={ZhongShang_Round=0}] unless entity @a[scores={ZhongShang_Round=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
execute unless entity @a[scores={ZhongShang_Round=0}] if entity @a[scores={ZhongShang_Round=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
execute if entity @a[scores={ZhongShang_Round=0}] if entity @a[scores={ZhongShang_Round=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
#沉默
scoreboard players remove @a[scores={chengmo=1..}] chengmo 1
#狼群战术
execute if entity @a[scores={langqunzhanshu=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.9", fallback: "[狼群战术]",color:"light_purple",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.4", fallback: "生效至\n",color:"gray"},{selector:"@a[scores={langqunzhanshu=1}]",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.10", fallback: "\n他们本回合不抽卡",color:"gray",bold:true}]
execute if entity @a[scores={langqunzhanshu=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
...
#隐匿仓库
execute if entity @a[scores={yinnicangku=1..,CanuseKard=1}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.11", fallback: "[隐匿仓库]",color:"light_purple",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.4", fallback: "生效至\n",color:"gray"},{selector:"@a[scores={yinnicangku=1,CanuseKard=1}]",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.12", fallback: "\n他们本回合多12K",color:"gray",bold:true}]
execute if entity @e[scores={yinnicangku=1..,CanuseKard=1}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
...
#生产令
execute if entity @a[scores={shengchanling=1..,CanuseKard=1}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.13", fallback: "[生产令]",color:"light_purple",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.4", fallback: "生效至\n",color:"gray"},{selector:"@a[scores={shengchanling=1,CanuseKard=1}]",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.14", fallback: "\n他们本回合多2张牌",color:"gray",bold:true}]
execute if entity @e[scores={shengchanling=1..,CanuseKard=1}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
...
execute if entity @a[team=red,scores={kujie=1..}] run tellraw @a [[{translate: "kards.function.game.end.win.red_win.1", fallback: "红队",color:"red",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.15", fallback: "[枯竭]",color:"dark_gray",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.16", fallback: "生效中",color:"dark_gray",bold:true}],{translate: "kards.function.game.ingame.round.take_turns.round.17", fallback: "\n使用牌后额外扣除1K直至回合结束",color:"gold"}]
execute if entity @a[team=blue,scores={kujie=1..}] run tellraw @a [[{translate: "kards.function.game.end.win.blue_win.2", fallback: "蓝队",color:"blue",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.15", fallback: "[枯竭]",color:"dark_gray",bold:true},{translate: "kards.function.game.ingame.round.take_turns.round.16", fallback: "生效中",color:"dark_gray",bold:true}],{translate: "kards.function.game.ingame.round.take_turns.round.17", fallback: "\n使用牌后额外扣除1K直至回合结束",color:"gold"}]
execute if entity @a[scores={kujie=1..}] run tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.8", fallback: "-",color:"gray"}]
#地狱、漫水
...
execute if entity @a[scores={hurt_by_mafeng=1,CanuseKard=1}] run tellraw @a [{selector:"@a[scores={hurt_by_mafeng=1,CanuseKard=1}]"},{translate: "kards.function.game.ingame.round.take_turns.round.18", fallback: "上回合被马蜂蛰了 -2K",color:"gray"}]
...
#tellraw @a [{translate: "kards.function.game.ingame.round.take_turns.round.19", fallback: "=======================",color:"gray",bold:true}]