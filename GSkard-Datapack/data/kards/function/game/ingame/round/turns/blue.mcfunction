...
execute as @e[type=!player,tag=!tuteng,team=red] run data modify entity @s Silent set value 1b
...
execute as @e[type=!player,tag=!tuteng,team=blue] run data modify entity @s Silent set value 0b