...
execute if score system DifficultyRound matches 1 run tellraw @a [{translate: "game.ingame.round.startround.2",color:"gold",bold:true},{translate: "game.ingame.round.startround.3",color:"gray",bold:true}]
execute if score system DifficultyRound matches 1 run return run difficulty hard
tellraw @a [{translate: "game.ingame.round.startround.4",color:"gold",bold:true},{translate: "game.ingame.round.startround.5",color:"gray",bold:true}]
difficulty normal