execute unless score @s Xp_Levels matches 85.. run tellraw @s [{text:"[经验商店]",color:"green"},{text:"您的经验不足",color:"red"}]
...
tellraw @s [{text:"[经验商店]",color:"green"},{text:"您消耗了",color:"gray"},{text:"85级经验",color:"gold"},{text:"购买了",color:"gray"},{text:"风行者 ",color:"white"},{text:"I",color:"gray"}]
