...
tellraw @s [{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.1", fallback: "[经验商店]",color:"green"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.3", fallback: "您消耗了",color:"gray"},{translate: "kards.function.game.xp.shop.enchantment.fengxingzhe.1", fallback: "85级经验",color:"gold"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.5", fallback: "购买了",color:"gray"},{translate: "kards.function.game.xp.shop.enchantment.fengxingzhe.2", fallback: "风行者 ",color:"white"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.7", fallback: "I",color:"gray"}]
