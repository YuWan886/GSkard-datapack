...
tellraw @s [{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.1", fallback: "[经验商店]",color:"green"},{translate: "kards.function.game.player.talent.combat.1.2", fallback: "您消耗了",color:"gray"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.3", fallback: "70级经验",color:"gold"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.4", fallback: "购买了",color:"gray"},{translate: "kards.function.game.xp.shop.enchantment.dadishenyou.1", fallback: "大地神佑 ",color:"green"},{translate: "kards.function.game.xp.shop.enchantment.bingshuangjingji.6", fallback: "I",color:"gray"}]
