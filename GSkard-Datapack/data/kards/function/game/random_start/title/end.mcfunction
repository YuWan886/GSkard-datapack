...
execute if score #system random_start matches 12 run tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1281", fallback: "所有人只能抽取到",color:"gray",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1292", fallback: "[舞王僵尸]",color:"dark_green",bold:true}]
...
execute if score #system random_start matches 13 run tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1294", fallback: "每使用1张牌 都有概率额外获得",color:"gray",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1295", fallback: "[春暖花开]",color:"light_purple",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1296", fallback: "[好高骛远]",color:"white",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1297", fallback: "6K",color:"gold",bold:true}]
...
execute if score #system random_start matches 14 run tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1278", fallback: "所有人默认使用",color:"gray",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1299", fallback: "[贪欲魔盒]",color:"white",bold:true}]
