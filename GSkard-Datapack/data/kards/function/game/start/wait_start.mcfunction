...
#发初始武器
item replace entity @a[tag=Ready] container.0 with minecraft:golden_carrot[minecraft:item_name={translate: "game.start.wait_start.1",color:"gold"},lore=[{translate: "game.start.wait_start.2",color:"gray",italic:false},{translate: "game.start.wait_start.3",color:"dark_gray",italic:true},{translate: "game.end.reset.11"},{translate: "game.start.wait_start.4",color:"gray",italic:false},{translate: "game.start.wait_start.5",color:"dark_green",italic:false},{translate: "game.start.wait_start.6",color:"dark_green",italic:false}],minecraft:attribute_modifiers=[{type:"attack_damage",amount:3,id:"",operation:"add_value",slot:"mainhand"},{type:"attack_speed",amount:-0.5,slot:"mainhand",operation:"add_value",id:""}],custom_data={kards:'金胡萝卜'},max_stack_size=1,tooltip_display={hidden_components:["attribute_modifiers","unbreakable"]}]
#发初始装备
#红
...
scoreboard players set #kard_start kardCount 10 start
