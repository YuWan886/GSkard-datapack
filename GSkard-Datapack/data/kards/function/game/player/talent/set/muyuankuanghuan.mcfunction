...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.muyuankuanghuan.1", fallback: "「墓园狂欢」",color:white,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]