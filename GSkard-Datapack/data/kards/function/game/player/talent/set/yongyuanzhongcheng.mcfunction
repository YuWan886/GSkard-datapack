...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.enable.yongyuanzhongcheng.3.1", fallback: "「永远忠诚」",color:aqua,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]