...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.ranjiweiguang.1", fallback: "「燃己为光」",color:red,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]