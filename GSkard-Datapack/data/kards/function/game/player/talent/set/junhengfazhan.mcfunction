...
tag @s add Talent_junhengfazhan
...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.junhengfazhan.1", fallback: "「均衡发展」",color:aqua,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]