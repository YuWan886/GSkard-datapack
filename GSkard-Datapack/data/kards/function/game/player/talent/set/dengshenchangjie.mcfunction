...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.dengshenchangjie.1", fallback: "「登神长阶」",color:gold,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]