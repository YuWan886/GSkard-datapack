...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.bujingtanyu.2", fallback: "「不尽贪欲」",color:light_purple,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]