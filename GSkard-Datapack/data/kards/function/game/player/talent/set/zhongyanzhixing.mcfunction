...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.enable.zhongyanzhixing.1.1", fallback: "「终焉之行」",color:light_purple,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]