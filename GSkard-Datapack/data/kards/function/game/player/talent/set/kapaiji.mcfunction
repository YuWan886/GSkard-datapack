...
# Tellraw
execute as @s[team=red] run tellraw @a[team=red,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"卡牌集",color:"light_purple",hover_event:{action:"show_text",value:[{text:"你抽15张牌",color:"gold"}]}}]
execute as @s[team=blue] run tellraw @a[team=blue,distance=0.1..] [{selector:"@s"},{text:"选择了",color:"gray"},{text:"卡牌集",color:"light_purple",hover_event:{action:"show_text",value:[{text:"你抽15张牌",color:"gold"}]}}]