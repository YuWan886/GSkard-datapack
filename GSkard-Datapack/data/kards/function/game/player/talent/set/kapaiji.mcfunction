...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.kapaiji.1", fallback: "「卡牌集」",color:gold,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]