...
execute at @s run function kards:game/player/talent/enable/shouhuzhe/1
...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.shouhuzhe.1", fallback: "「守护者」",color:gray,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]