...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.emoqiyue.1", fallback: "「恶魔契约」",color:dark_gray,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]