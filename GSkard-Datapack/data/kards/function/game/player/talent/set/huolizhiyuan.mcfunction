...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.huolizhiyuan.1", fallback: "「火力支援」",color:red,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]