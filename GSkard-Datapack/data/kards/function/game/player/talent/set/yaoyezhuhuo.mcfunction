...
# Tellraw
tellraw @s [{translate: "kards.function.game.player.talent.set.yaoyezhuhuo.1", fallback: "「摇曳烛火」",color:red,bold:true},{translate: "kards.function.game.player.talent.set.bujingtanyu.3", fallback: "已开启!",color:gold,bold:true}]