execute if score @s Talent_Combat matches 0 unless score @s Talent_Count matches 1.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的构想不足",color:"red"}]
...
execute if score @s Talent_Combat matches 1 unless score @s Talent_Count matches 2.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的构想不足",color:"red"}]
...
execute if score @s Talent_Combat matches 2 unless score @s Talent_Count matches 3.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的构想不足",color:"red"}]
...
execute if score @s Talent_Combat matches 3 unless score @s Talent_Count matches 4.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的构想不足",color:"red"}]
...
execute if score @s Talent_Combat matches 4 unless score @s Talent_Count matches 5.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的构想不足",color:"red"}]
...
execute if score @s Talent_Combat matches 5.. run tellraw @s [{text:"[天赋]",color:"green"},{text:"您的战斗等级已满",color:"gold"}]
