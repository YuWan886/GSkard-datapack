...
execute anchored eyes positioned ^ ^ ^2 summon marker at @s rotated as @p[tag=Talent_ranjiweiguang] run function kards:game/player/talent/enable/ranjiweiguang/3
