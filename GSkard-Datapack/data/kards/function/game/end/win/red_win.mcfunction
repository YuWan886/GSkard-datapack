...
clear @a
tp @a[team=red] 30 238 -26
tp @a[team=blue] 9 225 -26
...
title @a title [{translate: "game.end.win.red_win.1",color:"red",bold:true},{translate: "game.end.win.blue_win.3",color:"gold",bold:true}]
