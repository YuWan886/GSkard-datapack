execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{text: "使用了",color:"gold"},{text: "[三人成众]",color:"dark_green",hover_event:{action:"show_text",value:"召唤三只大的岩浆史莱姆,每10秒生成一只小岩浆史莱姆"}}]
