execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.juntuan.shixuelangqun.1",color:"dark_green",hover_event:{action:"show_text","value":"在敌方召唤6只狼 狼攻击附带凋零与吸血且不会被击退"}}]
    #红队用
