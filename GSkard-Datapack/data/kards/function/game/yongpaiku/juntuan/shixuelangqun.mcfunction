...
execute if entity @s[team=red] if score @s kardCount matches 0 run effect give @a[team=blue] blindness 20 0 true
execute if entity @s[team=blue] if score @s kardCount matches 0 run effect give @a[team=red] blindness 20 0 true
