execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.juntuan.xiajieruqing.1.1",color:"dark_green",hover_event:{action:"show_text","value":"召唤1只猪灵 回收所有基本牌 每回收1张基本牌 多召唤1只"}}]
#存储数量
