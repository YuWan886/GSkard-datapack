execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[飓风过境]","color":"dark_green","hoverEvent":{"action":"show_text","value":"在敌方召唤5只旋风人"}}]
    #红队用
