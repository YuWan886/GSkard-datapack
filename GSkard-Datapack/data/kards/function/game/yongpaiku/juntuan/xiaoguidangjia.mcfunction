execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[小鬼当家]","color":"dark_green","hoverEvent":{"action":"show_text","value":"在敌方召唤4只攻击分别造成凋零 中毒 失明 缓慢的小僵尸"}}]
   #红队用
