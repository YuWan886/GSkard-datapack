...
execute if score @s random_clear matches 0 unless items entity @s container.0 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 1 unless items entity @s container.1 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 2 unless items entity @s container.2 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 3 unless items entity @s container.3 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 4 unless items entity @s container.4 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 5 unless items entity @s container.5 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 6 unless items entity @s container.6 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 7 unless items entity @s container.7 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 8 unless items entity @s container.8 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 9 unless items entity @s container.9 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 10 unless items entity @s container.10 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 11 unless items entity @s container.11 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 12 unless items entity @s container.12 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 13 unless items entity @s container.13 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 14 unless items entity @s container.14 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 15 unless items entity @s container.15 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 16 unless items entity @s container.16 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 17 unless items entity @s container.17 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 18 unless items entity @s container.18 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 19 unless items entity @s container.19 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 20 unless items entity @s container.20 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 21 unless items entity @s container.21 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 22 unless items entity @s container.22 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 23 unless items entity @s container.23 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 24 unless items entity @s container.24 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 25 unless items entity @s container.25 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 26 unless items entity @s container.26 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 27 unless items entity @s container.27 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 28 unless items entity @s container.28 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 29 unless items entity @s container.29 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 30 unless items entity @s container.30 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 31 unless items entity @s container.31 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 32 unless items entity @s container.32 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 33 unless items entity @s container.33 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 34 unless items entity @s container.34 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
execute if score @s random_clear matches 35 unless items entity @s container.35 #minecraft:creeper_drop_music_discs run return run function kards:game/yongpaiku/shenji/shenzhiyishou/2
