execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[飞雷神]","color":"white","hoverEvent":{"action":"show_text","value":"传送至敌方区域 10s后折回"}}]
