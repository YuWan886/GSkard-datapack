execute unless score system status matches 0 run execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.shenji.wangzhibaoku.random1.1",color:"white",hover_event:{action:"show_text","value":"抽取一次王之宝库"}}]
