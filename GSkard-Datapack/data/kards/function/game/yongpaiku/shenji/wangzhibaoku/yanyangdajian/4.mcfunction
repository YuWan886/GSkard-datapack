...
execute unless entity @e[tag=marker_feixue_2,distance=..0.3] positioned ^ ^ ^0.15 run return run function kards:game/yongpaiku/shenji/wangzhibaoku/yanyangdajian/4
