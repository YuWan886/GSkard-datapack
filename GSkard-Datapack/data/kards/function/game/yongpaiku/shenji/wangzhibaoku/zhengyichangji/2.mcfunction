...
execute if score @s[team=red] used_zhengyichangji matches 0 at @s as @e[team=blue,distance=..5] run damage @s 12 kards:chuanci by @p[team=red,tag=zhengyichangji]
execute if score @s[team=blue] used_zhengyichangji matches 0 at @s as @e[team=red,distance=..5] run damage @s 12 kards:chuanci by @p[team=blue,tag=zhengyichangji]
