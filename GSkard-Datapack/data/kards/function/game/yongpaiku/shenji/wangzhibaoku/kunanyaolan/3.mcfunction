...
scoreboard players set #system damage_kutongzhuanhua 65
...
scoreboard players operation @s damage_kutongzhuanhua /= #system damage_kutongzhuanhua
tellraw @s [{text:"[!]]",color:"yellow"},{text:"苦痛转化触发 对周围敌对生物造成",color:"red"},{score:{name:"@s",objective:"damage_kutongzhuanhua"}},{text:"♥真实伤害",color:"red"}]
scoreboard players operation @s damage_kutongzhuanhua *= #system damage_kutongzhuanhua
