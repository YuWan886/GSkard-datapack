execute at @s if entity @e[tag=hurt_for_feixue,distance=..1] run return run function kards:game/yongpaiku/shenji/wangzhibaoku/yanyangdajian/stop
...
kill @e[tag=marker_feixue_1]
kill @e[tag=marker_feixue_2]
kill @s