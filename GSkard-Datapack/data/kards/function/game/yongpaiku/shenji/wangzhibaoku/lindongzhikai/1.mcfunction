...
scoreboard players add @s DongJie 90
tag @s add DongJie
...
execute if entity @s[team=red] run scoreboard players add @a[team=blue] HealBack 1
execute if entity @s[team=blue] run scoreboard players add @a[team=red] HealBack 1
