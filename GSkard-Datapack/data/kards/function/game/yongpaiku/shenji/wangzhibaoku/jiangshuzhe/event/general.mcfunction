...
#失重
execute if score 红队_讲述者 jiangshuzhe_shizhong matches 1 if predicate kards:random0.01 run effect give @r[gamemode=adventure,team=blue] levitation 3 3 false
execute if score 蓝队_讲述者 jiangshuzhe_shizhong matches 1 if predicate kards:random0.01 run effect give @r[gamemode=adventure,team=red] levitation 3 3 false
#河豚
...
#力量
execute if score 红队_讲述者 jiangshuzhe_liliang matches 1 run effect give @e[team=red] strength 1 0 false
execute if score 蓝队_讲述者 jiangshuzhe_liliang matches 1 run effect give @e[team=blue] strength 1 0 false
#速度
execute if score 红队_讲述者 jiangshuzhe_sudu matches 1 run effect give @e[team=red] speed 1 0 false
execute if score 蓝队_讲述者 jiangshuzhe_sudu matches 1 run effect give @e[team=blue] speed 1 0 false
#隐身
execute if score 红队_讲述者 jiangshuzhe_yinshen matches 1 run scoreboard players add 红队_讲述者 jiangshuzhe_yinshen_jishi 1
execute if score 红队_讲述者 jiangshuzhe_yinshen matches 1 if score 红队_讲述者 jiangshuzhe_yinshen_jishi matches 100 run effect give @e[team=red] invisibility 3 1 false
...
execute if score 蓝队_讲述者 jiangshuzhe_yinshen matches 1 if score 蓝队_讲述者 jiangshuzhe_yinshen_jishi matches 100 run effect give @e[team=red] invisibility 3 1 false
...
#抵御
execute if score 红队_讲述者 jiangshuzhe_diyu matches 1 run effect give @e[team=red] minecraft:resistance 1 0 false
execute if score 蓝队_讲述者 jiangshuzhe_diyu matches 1 run effect give @e[team=blue] minecraft:resistance 1 0 false
#畸形
