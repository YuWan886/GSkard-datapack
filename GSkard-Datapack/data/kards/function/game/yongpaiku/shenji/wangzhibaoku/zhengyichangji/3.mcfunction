...
execute if entity @s[team=red] as @e[team=red,distance=..2.5] run damage @s 4 kards:chuanci by @p[tag=zhengyichangji,team=blue]
execute if entity @s[team=blue] as @e[team=blue,distance=..2.5] run damage @s 4 kards:chuanci by @p[tag=zhengyichangji,team=red]
