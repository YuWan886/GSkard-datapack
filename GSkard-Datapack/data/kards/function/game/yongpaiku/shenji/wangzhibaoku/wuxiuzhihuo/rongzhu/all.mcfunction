...
execute if score @s wuxiuzhihuo_shengji matches 180.. run advancement grant @s only kards:advancement/wuxiuzhihuo/1
execute if score @s wuxiuzhihuo_shengji matches 700.. run advancement grant @s only kards:advancement/wuxiuzhihuo/2
