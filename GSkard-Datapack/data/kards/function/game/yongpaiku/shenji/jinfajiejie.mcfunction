execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.shenji.jinfajiejie.1",color:"white",hover_event:{action:"show_text","value":"敌方随机两名玩家-4Kmax"}}]
