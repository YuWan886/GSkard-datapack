execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[禁法结界]","color":"white","hoverEvent":{"action":"show_text","value":"敌方随机两名玩家-4Kmax"}}]
