...
execute positioned as @e[tag=blue_marker_7] run tp @a[tag=fanxiangfeileishen,team=red] ~ 0 ~
execute positioned as @e[tag=red_marker_7] run tp @a[tag=fanxiangfeileishen,team=blue] ~ 0 ~
