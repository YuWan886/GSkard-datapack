execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[胜利号角]","color":"white","hoverEvent":{"action":"show_text","value":"敌方区域怪物获得3s速度4与力量4"}}]
