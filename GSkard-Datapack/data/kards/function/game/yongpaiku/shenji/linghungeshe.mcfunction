execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[灵魂割舍]","color":"white","hoverEvent":{"action":"show_text","value":"斩杀敌方等于低于25生命值的所有玩家"}}]
