execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.shenji.linghungeshe.1",color:"white",hover_event:{action:"show_text","value":"斩杀敌方等于低于25生命值的所有玩家"}}]
