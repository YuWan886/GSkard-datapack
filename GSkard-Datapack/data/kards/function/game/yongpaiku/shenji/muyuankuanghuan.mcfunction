execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[墓园狂欢]","color":"white","hoverEvent":{"action":"show_text","value":"此后任意方式获取的基本牌 军团牌 诅咒牌 陷阱牌都变为特殊的衍生卡"}}]
