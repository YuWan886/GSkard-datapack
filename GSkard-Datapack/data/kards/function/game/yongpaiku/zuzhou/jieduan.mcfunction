execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[截断]","color":"dark_gray","hoverEvent":{"action":"show_text","value":"敌方玩家获得挖掘疲劳5 持续20s"}}]
