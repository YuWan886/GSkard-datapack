execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[沉默]","color":"dark_gray","hoverEvent":{"action":"show_text","value":"本回合与下回合 持续清除敌方所有玩家身边的掉落物"}}]
