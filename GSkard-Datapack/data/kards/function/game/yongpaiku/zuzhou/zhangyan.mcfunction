execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.zuzhou.zhangyan.1",color:"dark_gray",hover_event:{action:"show_text","value":"敌方玩家获得失明 持续20s"}}]
#红
