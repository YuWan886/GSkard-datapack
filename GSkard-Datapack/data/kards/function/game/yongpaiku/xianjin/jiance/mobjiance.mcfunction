...
execute if entity @s[team=red] if score 红队 xianjin_sunhaoguodu matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<损耗过度>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时-7K"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_sunhaoguodu matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<损耗过度>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时-7K"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_shusifangshou matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<殊死防守>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时给予使用该陷阱的队伍60s额外生命20♥"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_shusifangshou matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<殊死防守>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时给予使用该陷阱的队伍60s额外生命20♥"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_hewei matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<合围>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_hewei matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<合围>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
