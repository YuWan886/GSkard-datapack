...
execute if entity @s[team=red] if score 红队 xianjin_shusifangshou matches 1 run tellraw @a [{selector: "@s"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.mobjiance.2",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时给予使用该陷阱的队伍60s额外生命20♥"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_shusifangshou matches 1 run tellraw @a [{selector: "@s"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.mobjiance.2",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时给予使用该陷阱的队伍60s额外生命20♥"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_hewei matches 1 run tellraw @a [{selector: "@s"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.mobjiance.3",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_hewei matches 1 run tellraw @a [{selector: "@s"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.mobjiance.3",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
