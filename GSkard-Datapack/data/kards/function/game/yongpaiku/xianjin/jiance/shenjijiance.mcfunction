...
execute if entity @s[team=red] if score 红队 xianjin_laizishenchu matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<来自深处>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时让使用该陷阱牌队伍所有玩家回复血量16♥"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_laizishenchu matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<来自深处>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时让使用该陷阱牌队伍所有玩家回复血量16♥"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_qianjunyifa matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<千钧一发>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时让使用该陷阱牌队伍场地所有敌对怪物传送至触发者队伍场地"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_qianjunyifa matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<千钧一发>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时让使用该陷阱牌队伍场地所有敌对怪物传送至触发者队伍场地"}}]
