...
execute if score 红队 xianjin_qinglvqianmou matches 1 run tellraw @a [{text: "红队",color: "red"},{text: "触发了",color: "gray"},{text: "<轻虑浅谋>",color: "dark_aqua",hover_event:{action:"show_text",value:"触发时让触发者队伍所有玩家扣除等同于本回合内使用卡牌数量的血量"}}]
...
execute if score 蓝队 xianjin_qinglvqianmou matches 1 run tellraw @a [{text: "蓝队",color: "blue"},{text: "触发了",color: "gray"},{text: "<轻虑浅谋>",color: "dark_aqua",hover_event:{action:"show_text",value:"触发时让触发者队伍所有玩家扣除等同于本回合内使用卡牌数量的血量"}}]
...
execute if score 红队 xianjin_toulianghuanzhu matches 1 run tellraw @a [{text: "红队",color: "red"},{text: "触发了",color: "gray"},{text: "<偷梁换柱>",color: "dark_aqua",hover_event:{action:"show_text",value:"记录敌方一名K点最多的玩家的K点 在下回合时使其均分给我方所有玩家 每名玩家最多6K(不取余数)"}}]
...
execute if score 蓝队 xianjin_toulianghuanzhu matches 1 run tellraw @a [{text: "蓝队",color: "blue"},{text: "触发了",color: "gray"},{text: "<偷梁换柱>",color: "dark_aqua",hover_event:{action:"show_text",value:"记录敌方一名K点最多的玩家的K点 在下回合时使其均分给我方所有玩家 每名玩家最多6K(不取余数)"}}]
