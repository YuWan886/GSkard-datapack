...
execute if score 红队 xianjin_yaoyuandeqiao matches 1 run tellraw @a [{translate: "game.end.win.red_win.1",color: "red"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.1",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
...
execute if score 蓝队 xianjin_yaoyuandeqiao matches 1 run tellraw @a [{translate: "game.end.win.blue_win.2",color: "blue"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.1",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时清除使用该陷阱的队伍的场上所有敌对怪物"}}]
...
execute if score 红队 xianjin_qinglvqianmou matches 1 run tellraw @a [{translate: "game.end.win.red_win.1",color: "red"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.2",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时让触发者队伍所有玩家扣除等同于本回合内使用卡牌数量的血量"}}]
...
execute if score 蓝队 xianjin_qinglvqianmou matches 1 run tellraw @a [{translate: "game.end.win.blue_win.2",color: "blue"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.2",color: "dark_aqua",hover_event:{action:"show_text","value":"触发时让触发者队伍所有玩家扣除等同于本回合内使用卡牌数量的血量"}}]
...
execute if score 红队 xianjin_toulianghuanzhu matches 1 run tellraw @a [{translate: "game.end.win.red_win.1",color: "red"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.3",color: "dark_aqua",hover_event:{action:"show_text","value":"记录敌方一名K点最多的玩家的K点 在下回合时使其均分给我方所有玩家 每名玩家最多6K(不取余数)"}}]
...
execute if score 蓝队 xianjin_toulianghuanzhu matches 1 run tellraw @a [{translate: "game.end.win.blue_win.2",color: "blue"},{translate: "game.yongpaiku.xianjin.jiance.fashujiance.1",color: "gray"},{translate: "game.yongpaiku.xianjin.jiance.roundjiance.3",color: "dark_aqua",hover_event:{action:"show_text","value":"记录敌方一名K点最多的玩家的K点 在下回合时使其均分给我方所有玩家 每名玩家最多6K(不取余数)"}}]
