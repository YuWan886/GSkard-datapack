...
#施法小鬼
execute if entity @s[team=red] if score 红队 xianjin_shifaxiaogui matches 1 at @s run function kards:game/yongpaiku/xianjin/chufa/hewei
execute if entity @s[team=blue] if score 蓝队 xianjin_shifaxiaogui matches 1 at @s run function kards:game/yongpaiku/xianjin/chufa/hewei
...
#<偷梁换柱>
execute if entity @s[team=red] if score 红队 xianjin_youdi matches 1 at @s run function kards:game/yongpaiku/xianjin/chufa/toulianghuanzhu
execute if entity @s[team=blue] if score 蓝队 xianjin_youdi matches 1 at @s run function kards:game/yongpaiku/xianjin/chufa/toulianghuanzhu
