...
#施法小鬼
execute if entity @s[team=red] if score 红队 xianjin_shifaxiaogui matches 1 at @s run summon zombie ~ ~ ~ {IsBaby:1b,Team:blue,attributes:[{id:"follow_range",base:100},{id:"follow_range",base:100},{id:"minecraft:movement_speed",base:0.6d}]}
...
execute if entity @s[team=blue] if score 蓝队 xianjin_shifaxiaogui matches 1 at @s run summon zombie ~ ~ ~ {IsBaby:1b,Team:red,attributes:[{id:"follow_range",base:100},{id:"follow_range",base:100},{id:"minecraft:movement_speed",base:0.6d}]}
