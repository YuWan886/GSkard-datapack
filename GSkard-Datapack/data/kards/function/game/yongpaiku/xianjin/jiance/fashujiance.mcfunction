...
execute if entity @s[team=red] if score 红队 xianjin_shifaxiaogui matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<施法小鬼>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时在触发者场地生成1只移速提升的小僵尸"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_shifaxiaogui matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<施法小鬼>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时在触发者场地生成1只移速提升的小僵尸"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_jingxiahezi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<惊吓盒子>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时在触发者场地生成1只略微加速爆炸的苦力怕"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_jingxiahezi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<惊吓盒子>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时在触发者场地生成1只略微加速爆炸的苦力怕"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_molifushi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<魔力腐蚀>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时对触发者造成5♥真实伤害"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_molifushi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<魔力腐蚀>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时对触发者造成5♥真实伤害"}}]
...
#<法术失效>
execute if entity @s[team=red] if score 红队 xianjin_shufashixiao matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<法术失效>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时使该法术失效"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_shufashixiao matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<法术失效>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时使该法术失效"}}]
...
execute if entity @s[team=red] if score 红队 xianjin_youdi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<诱敌>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时使该法术失效(对于第二张法术牌)"}}]
...
execute if entity @s[team=blue] if score 蓝队 xianjin_youdi matches 1 run tellraw @a [{"selector": "@s"},{"text": "触发了","color": "gray"},{"text": "<诱敌>","color": "dark_aqua","hoverEvent":{"action":"show_text","value":"触发时使该法术失效(对于第二张法术牌)"}}]
