execute if entity @s[team=red] if score @s pingbi matches 0 run tellraw @a[team=red] [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.paiku.fashu.jieshi.2.13",color:"dark_aqua",hover_event:{action:"show_text","value":"条件：敌方回合结束时\n触发：敌方玩家每用1张牌就对自己造成0.5♥伤害"}}]
...
execute if entity @s[team=blue] if score @s pingbi matches 0 run tellraw @a[team=blue] [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.paiku.fashu.jieshi.2.13",color:"dark_aqua",hover_event:{action:"show_text","value":"条件：敌方回合结束时\n触发：敌方玩家每用1张牌就对自己造成0.5♥伤害"}}]
