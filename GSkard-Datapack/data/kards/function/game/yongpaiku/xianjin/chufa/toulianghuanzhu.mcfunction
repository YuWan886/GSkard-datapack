...
execute if entity @s[team=blue] run scoreboard players set 红队 xianjin_toulianghuanzhu 0

data modify entity @n[tag=copy,type=item] Item set from entity @s Inventory.[{Slot:-106b}]
