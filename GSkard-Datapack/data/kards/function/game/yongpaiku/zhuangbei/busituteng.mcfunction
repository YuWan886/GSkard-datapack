...
execute if score @s random_busituteng matches 1 run give @s minecraft:totem_of_undying[custom_name={italic:false,text: "自爆图腾",color:"red"},lore=[{text: "在死亡时自爆",color:"gray",italic:false},{text: "对周围所有生物造成35♥无差别伤害",color:"gray",italic:false}],custom_data={kards:'自爆图腾'}]
execute if score @s random_busituteng matches 2 run give @s minecraft:totem_of_undying[custom_name={italic:false,text: "生命图腾",color:"green"},lore=[{text: "在拥有原版不死图腾效能基础上",color:"gray",italic:false},{text: "还会获得更多额外生命 以及60s生命回复",color:"gray",italic:false}],custom_data={kards:'生命图腾'}]
...
execute if score @s random_busituteng matches 5 run give @s minecraft:totem_of_undying[custom_name={italic:false,text: "冻结图腾",color:"aqua"},lore=[{text: "在拥有原版不死图腾效能基础上",color:"gray",italic:false},{text: "还会冻结周围敌对生物 持续10s",color:"gray",italic:false}],custom_data={kards:'冻结图腾'}]
