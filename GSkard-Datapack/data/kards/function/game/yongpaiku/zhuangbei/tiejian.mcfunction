execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.zhuangbei.tiejian.1",color:"gold"}]
give @s minecraft:iron_sword[minecraft:item_name={translate: "game.yongpaiku.zhuangbei.tiejian.2",color:"white"},lore=[{translate: "game.yongpaiku.zhuangbei.tiejian.3",color:"gray",italic:false},{translate: "game.yongpaiku.zhuangbei.tiejian.4",color:"dark_gray",italic:true},{translate: "game.end.reset.11"},{translate: "game.start.wait_start.4",color:"gray",italic:false},{translate: "game.yongpaiku.shenji.wangzhibaoku.sishenzhilian.give.8",color:"dark_green",italic:false},{translate: "game.yongpaiku.shenji.wangzhibaoku.shizhongjian.give.13",color:"dark_green",italic:false}],minecraft:attribute_modifiers={modifiers:[{type:"attack_damage",amount:7,id:"",operation:"add_value",slot:"mainhand"},{type:"attack_speed",amount:-2.4,slot:"mainhand",operation:"add_value",id:""}],show_in_tooltip:0b},custom_data={kards:'铁剑'},minecraft:unbreakable={},tooltip_display={hidden_components:["attribute_modifiers","unbreakable"]}]
