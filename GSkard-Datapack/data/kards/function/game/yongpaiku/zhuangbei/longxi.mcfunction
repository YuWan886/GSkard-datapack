execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[龙息]","color":"gold","hoverEvent":{"action":"show_text","value":"获得一瓶龙息 一次性道具 可在任意时刻使用"}}]
