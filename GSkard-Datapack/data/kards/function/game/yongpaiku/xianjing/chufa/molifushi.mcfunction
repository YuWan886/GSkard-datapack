...
tellraw @a [{selector: "@s"},{translate: "kards.function.game.yongpaiku.xianjing.chufa.hewei.1", fallback: "触发了",color: "gray"},{translate: "kards.function.game.yongpaiku.xianjing.chufa.molifushi.1", fallback: "<魔力腐蚀>",color: "dark_aqua",hover_event:{action:"show_text",value:"触发时对触发者造成5♥真实伤害"}}]
