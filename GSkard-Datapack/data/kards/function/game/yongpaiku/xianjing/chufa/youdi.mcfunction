...
tellraw @a [{selector: "@s"},{translate: "kards.function.game.yongpaiku.xianjing.chufa.hewei.1", fallback: "触发了",color: "gray"},{translate: "kards.function.game.yongpaiku.xianjing.chufa.youdi.1", fallback: "<诱敌>",color: "dark_aqua",hover_event:{action:"show_text",value:"触发时使该法术失效(对于第二张法术牌)"}}]
