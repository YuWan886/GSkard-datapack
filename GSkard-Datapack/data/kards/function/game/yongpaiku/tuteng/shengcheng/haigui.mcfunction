execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.haigui.1",color:"red",hover_event:{action:"show_text","value":"己方敌对生物获得缓慢1"}}]
