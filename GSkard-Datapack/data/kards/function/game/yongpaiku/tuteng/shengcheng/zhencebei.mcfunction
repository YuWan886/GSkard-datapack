execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.zhencebei.1",color:"red",hover_event:{action:"show_text","value":"队伍不会触发陷阱"}}]
