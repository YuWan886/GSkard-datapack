execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.zhencebei.1",color:"red",hover_event:{action:"show_text","value":"队伍不会触发陷阱"}}]
...
scoreboard players remove @s kardCount 18
