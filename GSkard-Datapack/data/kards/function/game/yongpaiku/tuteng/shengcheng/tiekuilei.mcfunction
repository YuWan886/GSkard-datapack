execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.tiekuilei.1",color:"red",hover_event:{action:"show_text","value":"在友方区域召唤一只75血的铁傀儡"}}]
