execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{text: "使用了",color:"gold"},{text: "[培养尸]",color:"red",hover_event:{action:"show_text",value:[{text: "图腾存活效果：",color:"gray",italic:false},[{text: "\n1.队伍玩家获得",color:"gray",italic:false},{text: "防火",color:"gold",italic:false}],[{text: "\n2.",color:"gray",italic:false},{text: "培养尸",color:"gold",italic:false},{text: "在造成",color:"gray",italic:false},{text: "30♥",color:"gold",italic:false},{text: "的生命之后变为",color:"gray",italic:false},{text: "[尸帝]",color:"dark_green",italic:false},{text: " 置入随机一名友方玩家手中",color:"gray",italic:false}],[{text: "-放置",color:"gray",italic:false},{text: "培养尸",color:"red",italic:false},{text: "时若队伍内有",color:"gray",italic:false},{text: "村民",color:"red",italic:false},{text: " 培养尸",color:"red",italic:false},{text: "会吞噬",color:"gray",italic:false},{text: "村民",color:"red",italic:false},{text: "以提升10♥培养值",color:"gray",italic:false}],[{text: "-回合开始时对敌方随机1名玩家造成",color:"gray",italic:false},{text: "5♥真实伤害",color:"white",italic:false}]]}}]
