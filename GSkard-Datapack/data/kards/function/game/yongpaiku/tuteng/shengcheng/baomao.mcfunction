execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.baomao.1",color:"red",hover_event:{action:"show_text","value":"队伍玩家获得速度2 回合结束时对敌方1个图腾造成4♥伤害"}}]
