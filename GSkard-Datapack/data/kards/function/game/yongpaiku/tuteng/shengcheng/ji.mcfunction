execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.tuteng.shengcheng.ji.1",color:"red",hover_event:{action:"show_text","value":"队伍玩家每回合多获得5使用点数"}}]
