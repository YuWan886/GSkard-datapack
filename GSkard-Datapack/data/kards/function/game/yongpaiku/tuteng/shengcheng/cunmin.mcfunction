execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[村民]","color":"red","hoverEvent":{"action":"show_text","value":"存活效果：队伍怪物获得抗性提升1,友方铁傀儡获得速度1,且回合结束时治疗自己"}}]
