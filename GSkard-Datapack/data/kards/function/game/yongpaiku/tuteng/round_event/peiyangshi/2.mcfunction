...
tellraw @a [{translate: "json.kards.dialog.paiku.tuteng.main.713", fallback: "培养尸",color:"red"},{translate: "kards.function.game.yongpaiku.tuteng.round_event.peiyangshi.2.1", fallback: "进化至",color:"gray"},{translate: "json.kards.dialog.paiku.tuteng.peiyangshi.732", fallback: "[尸帝]",color:"dark_green"},{translate: "kards.function.game.yongpaiku.tuteng.round_event.peiyangshi.2.2", fallback: "置入",color:"gray"},{selector:"@a[tag=peiyangshi_shidi]"}]
