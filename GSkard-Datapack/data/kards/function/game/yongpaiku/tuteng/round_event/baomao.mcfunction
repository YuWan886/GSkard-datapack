...
execute as @e[tag=baomao_damage,limit=1] if score @s tuteng_Health matches ..8 run tellraw @a [{selector:"@s"},{translate: "kards.function.game.yongpaiku.tuteng.round_event.baomao.2", fallback: "被咬死了",color:"gray"}]
