...
playsound minecraft:entity.player.hurt_freeze player @a[distance=..20] ~ ~ ~ 100 0
tag @s remove bingdongtuteng
effect clear @s
scoreboard players add @s HealBack 40
