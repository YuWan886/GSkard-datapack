...
execute if entity @s[team=red] at @s[distance=..5] as @e[tag=blue_marker_7,limit=1] at @s run tp @e[type=!player,tag=!tuteng,type=!marker] ~ -60 ~
execute if entity @s[team=blue] at @s[distance=..5] as @e[tag=red_marker_7,limit=1] at @s run tp @e[type=!player,tag=!tuteng,type=!marker] ~ -60 ~