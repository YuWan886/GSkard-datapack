...
execute if entity @s[team=red] if score 红队 tanyu_temp_2 matches 9 run tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1299", fallback: "[贪欲魔盒]",color:"gold"},{translate: "kards.function.game.end.win.red_win.1", fallback: "红队",color:"red"},{translate: "kards.function.game.yongpaiku.yansheng.tanyumohe.1.4", fallback: "罪恶值已达至第",color:"gray"},{score:{name:"红队",objective:"tanyu_temp_1"},color:"red"},{translate: "kards.function.game.yongpaiku.shenji.wangzhibaoku.tianshenshibanjia.bossbar.3.1", fallback: "层",color:"gray"}]
execute if entity @s[team=blue] if score 蓝队 tanyu_temp_2 matches 9 run tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1299", fallback: "[贪欲魔盒]",color:"gold"},{translate: "kards.function.game.end.win.blue_win.2", fallback: "蓝队",color:"blue"},{translate: "kards.function.game.yongpaiku.yansheng.tanyumohe.1.4", fallback: "罪恶值已达至第",color:"gray"},{score:{name:"蓝队",objective:"tanyu_temp_1"},color:"red"},{translate: "kards.function.game.yongpaiku.shenji.wangzhibaoku.tianshenshibanjia.bossbar.3.1", fallback: "层",color:"gray"}]
