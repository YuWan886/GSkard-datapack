execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[四季如春]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"抽两张牌并为队伍其他玩家回复4K"}}]
