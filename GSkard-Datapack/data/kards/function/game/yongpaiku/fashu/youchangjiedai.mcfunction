execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[有偿借贷]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"你获得12K 但-2Kmax"}}]
