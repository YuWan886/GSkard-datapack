execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[起死回生]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"回复16♥ 获得60s10♥额外生命"}}]
