execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.zhengxiu.1",color:"dark_purple",hover_event:{action:"show_text","value":"获得2张装备牌"}}]
