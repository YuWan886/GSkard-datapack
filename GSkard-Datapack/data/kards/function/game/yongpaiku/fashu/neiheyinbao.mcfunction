execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.paiku.fashu.duming.8",color:"dark_purple",hover_event:{action:"show_text","value":"引爆1名敌方玩家 伤害随难度增加伤害"}}]
