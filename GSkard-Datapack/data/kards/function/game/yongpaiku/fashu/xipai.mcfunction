execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[洗牌]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"将物品栏最左边两张牌回收 抽两张牌"}}]
