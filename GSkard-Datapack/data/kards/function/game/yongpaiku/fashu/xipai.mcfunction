execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.xipai.1",color:"dark_purple",hover_event:{action:"show_text","value":"将物品栏最左边两张牌回收 抽两张牌"}}]
