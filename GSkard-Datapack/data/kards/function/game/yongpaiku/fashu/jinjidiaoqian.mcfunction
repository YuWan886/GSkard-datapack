execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[紧急调遣]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"获得4Kmax"}}]
