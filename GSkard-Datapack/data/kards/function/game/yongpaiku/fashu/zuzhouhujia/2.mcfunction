...
tellraw @a [{selector:"@s"},{translate: "kards.function.game.yongpaiku.fashu.zuzhouhujia.1.2", fallback: "穿戴上了",color:"gold"},{translate: "kards.function.game.yongpaiku.fashu.zuzhouhujia.1.3", fallback: "<诅咒护甲>",color:"light_purple"}]
