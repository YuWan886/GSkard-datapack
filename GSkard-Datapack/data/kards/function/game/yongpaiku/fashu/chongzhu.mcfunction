execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.chongzhu.1",color:"dark_purple",hover_event:{action:"show_text","value":"将你所有的装备牌回收 每回收1张装备牌则抽一张牌"}}]
