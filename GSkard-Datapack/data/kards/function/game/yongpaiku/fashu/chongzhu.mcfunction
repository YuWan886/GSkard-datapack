execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[重铸]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"将你所有的装备牌回收 每回收1张装备牌则抽一张牌"}}]
