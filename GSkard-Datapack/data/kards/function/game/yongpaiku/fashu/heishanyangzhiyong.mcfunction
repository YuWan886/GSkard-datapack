execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.heishanyangzhiyong.1",color:"dark_purple",hover_event:{action:"show_text","value":"使用后进行一次随机点数(1~10) 根据结果不同获得不同效果"}}]
