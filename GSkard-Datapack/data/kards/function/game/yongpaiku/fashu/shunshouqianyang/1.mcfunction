...
execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[顺手牵羊]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"你弃掉敌方一名玩家一张牌,抽一张牌"}}]
