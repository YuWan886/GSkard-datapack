execute unless items entity @s container.* #kards:kard run return run tellraw @a [{selector:"@s"},{translate: "kards.function.game.yongpaiku.fashu.guohechaiqiao.2.1", fallback: "的滚木被",color:"aqua"},{selector:"@a[tag=User,limit=1]"},{translate: "kards.function.game.yongpaiku.fashu.shunshouqianyang.2.1", fallback: "偷走了!",color:"aqua"}]
...
tellraw @a [{selector:"@s"},{translate: "kards.function.game.yongpaiku.fashu.guohechaiqiao.2.3", fallback: "的一张牌被",color:"aqua"},{selector:"@a[tag=User,limit=1]"},{translate: "kards.function.game.yongpaiku.fashu.shunshouqianyang.2.2", fallback: "偷走了！",color:"aqua"}]