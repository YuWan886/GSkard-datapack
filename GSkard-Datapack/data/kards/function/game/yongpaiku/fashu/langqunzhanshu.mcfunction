execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.langqunzhanshu.1",color:"dark_purple",hover_event:{action:"show_text","value":"敌方两名玩家下回合开始时不能抽牌"}}]
