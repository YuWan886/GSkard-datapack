execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{text:"使用了",color:"gold"},{text:"[宰鸡教猴]",color:"dark_purple",hover_event:{action:"show_text",value:"杀死敌方一个图腾"}}]
