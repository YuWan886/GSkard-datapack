execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.wuyong.1",color:"dark_purple",hover_event:{action:"show_text","value":"获得三张无用的牌"}}]
...
give @s music_disc_mellohi[item_name=[{translate: "game.paiku.fashu.manshui.1",color:"aqua"},{translate: "game.yongpaiku.fashu.wuyong.2",color:"light_purple"}],lore=[{translate: "game.paiku.fashu.beishuiyizhan.3",color:"light_purple",italic:false},{translate: "game.yongpaiku.fashu.wuyong.3",color:"gray",italic:false},{translate: "game.paiku.fashu.wuyong.3",color:"gray",italic:false}],jukebox_playable="minecraft:pigstep",tooltip_display={hidden_components:["jukebox_playable"]},custom_data={kards:'无用•法'}]
