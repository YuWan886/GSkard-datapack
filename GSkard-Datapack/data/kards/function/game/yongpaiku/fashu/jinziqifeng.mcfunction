execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[禁字启封]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"增加5%抽取[禁字决]的概率\n最高为40%"}}]
