execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[死刑宣告]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"在敌方所有玩家头顶召唤造成高伤害的铁砧"}}]
