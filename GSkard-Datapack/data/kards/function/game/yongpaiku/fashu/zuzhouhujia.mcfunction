...
#红
execute if entity @s[team=red] as @r[team=blue] run item replace entity @s armor.chest with golden_chestplate[custom_name=["",{translate: "game.yongpaiku.fashu.zuzhouhujia.2",italic:false}],enchantments={binding_curse:1,unbreaking:1},attribute_modifiers=[{type:armor,amount:-0.5,slot:chest,operation:add_multiplied_total,id:""},{type:attack_damage,amount:-0.5,slot:chest,operation:add_multiplied_total,id:""},{type:attack_speed,amount:-0.5,slot:chest,operation:add_multiplied_total,id:""},{type:movement_efficiency,amount:-0.5,slot:chest,operation:add_multiplied_total,id:""}]]
#蓝
