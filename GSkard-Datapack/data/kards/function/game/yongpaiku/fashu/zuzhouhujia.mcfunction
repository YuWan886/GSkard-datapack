execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{text: "使用了",color:"gold"},{text: "[诅咒护甲]",color:"dark_purple",hover_event:{action:"show_text","value":"随机对敌方一名敌人和胸甲替换成 诅咒护甲 无法脱下 并且有额外减益效果"}}]
