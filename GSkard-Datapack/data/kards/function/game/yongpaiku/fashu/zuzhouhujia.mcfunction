execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.zuzhouhujia.1",color:"dark_purple",hover_event:{action:"show_text","value":"随机对敌方一名敌人和胸甲替换成 诅咒护甲 无法脱下 并且有额外减益效果"}}]
...
#红
execute if entity @s[team=red] as @r[team=blue] run item replace entity @s armor.chest with golden_chestplate[custom_name=["",{translate: "game.yongpaiku.fashu.zuzhouhujia.2",italic:false}],enchantments={binding_curse:1,unbreaking:1},attribute_modifiers=[{type:armor,amount:-0.5,slot:chest,operation:add_multiplied_total,id:1737366850050},{type:attack_damage,amount:-0.5,slot:chest,operation:add_multiplied_total,id:1737366850050},{type:attack_speed,amount:-0.5,slot:chest,operation:add_multiplied_total,id:1737366850050},{type:movement_efficiency,amount:-0.5,slot:chest,operation:add_multiplied_total,id:1737366850050}]]
#蓝
