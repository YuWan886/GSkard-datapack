execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.zhouranyingbao.1",color:"dark_purple",hover_event:{action:"show_text","value":"在敌方区域召唤一只威力加强的加速爆炸的苦力怕"}}]
