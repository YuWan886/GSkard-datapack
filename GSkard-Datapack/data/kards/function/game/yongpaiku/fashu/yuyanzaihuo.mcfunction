execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[预言灾祸]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"自身获得60s抗性提升4"}}]
