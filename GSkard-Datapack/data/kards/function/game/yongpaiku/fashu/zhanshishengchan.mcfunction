execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[战时生产]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"获得2Kmax"}}]
