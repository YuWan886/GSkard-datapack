...
execute if score 红队 fashu_duming > 蓝队 fashu_duming run tellraw @a [{translate: "game.yongpaiku.fashu.duming.6",color:"gray"},{translate: "game.end.win.red_win.1",color:"red"},{translate: "game.yongpaiku.fashu.duming.7",color:"gray"},{translate: "game.yongpaiku.fashu.duming.8",color:"gray"},{translate: "game.paiku.fashu.duming.8",color:"dark_purple"},{translate: "game.yongpaiku.fashu.duming.9",color:"gray"}]
execute if score 红队 fashu_duming < 蓝队 fashu_duming run tellraw @a [{translate: "game.yongpaiku.fashu.duming.6",color:"gray"},{translate: "game.end.win.blue_win.2",color:"blue"},{translate: "game.yongpaiku.fashu.duming.7",color:"gray"},{translate: "game.yongpaiku.fashu.duming.10",color:"gray"},{translate: "game.paiku.fashu.duming.8",color:"dark_purple"},{translate: "game.yongpaiku.fashu.duming.9",color:"gray"}]
