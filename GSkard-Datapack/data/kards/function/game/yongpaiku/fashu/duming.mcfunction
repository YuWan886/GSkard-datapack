execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.duming.1",color:"dark_purple",hover_event:{action:"show_text","value":"使用后双方队伍进行一次随机点数(1~100) 出现更小值的队伍随机一个玩家将受到内核引爆"}}]
...
execute if score 红队 fashu_duming > 蓝队 fashu_duming run tellraw @a [{translate: "game.yongpaiku.fashu.duming.6",color:"gray"},{translate: "game.end.win.red_win.1",color:"red"},{translate: "game.yongpaiku.fashu.duming.7",color:"gray"},{translate: "game.yongpaiku.fashu.duming.8",color:"gray"},{translate: "game.paiku.fashu.duming.7",color:"dark_purple"},{translate: "game.yongpaiku.fashu.duming.9",color:"gray"}]
execute if score 红队 fashu_duming < 蓝队 fashu_duming run tellraw @a [{translate: "game.yongpaiku.fashu.duming.6",color:"gray"},{translate: "game.end.win.blue_win.2",color:"blue"},{translate: "game.yongpaiku.fashu.duming.7",color:"gray"},{translate: "game.yongpaiku.fashu.duming.10",color:"gray"},{translate: "game.paiku.fashu.duming.7",color:"dark_purple"},{translate: "game.yongpaiku.fashu.duming.9",color:"gray"}]
execute if score 红队 fashu_duming = 蓝队 fashu_duming run tellraw @a [{translate: "game.yongpaiku.fashu.duming.11",color:"gray"}]
