execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[漫水]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"使敌方场地一格高区域空气替换为水 持续至回合结束 不可叠加"}}]
