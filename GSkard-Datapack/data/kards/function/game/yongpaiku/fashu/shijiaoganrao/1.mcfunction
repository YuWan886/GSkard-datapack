execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.yongpaiku.fashu.shijiaoganrao.1.1",color:"dark_purple",hover_event:{action:"show_text","value":"随机旋转敌方玩家视角"}}]
