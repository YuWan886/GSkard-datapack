execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[视角干扰]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"随机旋转敌方玩家视角"}}]
