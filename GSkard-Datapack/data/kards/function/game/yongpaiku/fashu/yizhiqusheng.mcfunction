execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{text: "使用了",color:"gold"},{text: "[以智取胜]",color:"dark_purple",hover_event:{action:"show_text","value":"获得1张装备牌和军团牌"}}]
