execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[盈余之力]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"消耗你所有的K 每消耗2K就给队伍所有玩家治疗1♥"}}]
