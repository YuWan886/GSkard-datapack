execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.wugufengdeng.1",color:"dark_purple",hover_event:{action:"show_text","value":"所有玩家抽一张牌"}}]
item replace entity @s weapon.offhand with air
scoreboard players operation @s kardCount -= #kard_xianfengdaojian kardCount
