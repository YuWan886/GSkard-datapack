execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[生产令]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"获得2Kmax 下回合多抽两张牌"}}]
