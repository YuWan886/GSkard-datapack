execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[水流涌动]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"抽一张牌 为队伍玩家回复8♥"}}]
