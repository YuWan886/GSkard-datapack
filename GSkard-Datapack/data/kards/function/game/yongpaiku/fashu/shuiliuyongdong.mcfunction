...
#红
execute if entity @s[team=red] run effect give @a[team=red] instant_health 1 2 true
#蓝
execute if entity @s[team=blue] run effect give @a[team=blue] instant_health 1 2 true
