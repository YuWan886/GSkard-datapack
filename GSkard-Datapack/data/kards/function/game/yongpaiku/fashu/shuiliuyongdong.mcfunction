execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.shuiliuyongdong.1",color:"dark_purple",hover_event:{action:"show_text","value":"抽一张牌 为队伍玩家回复8♥"}}]
