execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[背水一战]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"每有一个友方死亡 就获得10点数 抽二张牌"}}]
