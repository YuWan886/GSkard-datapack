execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.beishuiyizhan.1",color:"dark_purple",hover_event:{action:"show_text","value":"每有一个友方死亡 就获得10点数 抽二张牌"}}]
