execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.paiku.fashu.wuyongfa.1",color:"gold"},{translate: "game.paiku.fashu.junlintianxia.jy0.1",color:"white",hover_event:{action:"show_text","value":"对周围敌人造成伤害，恢复血量，抽一张卡"}}]
