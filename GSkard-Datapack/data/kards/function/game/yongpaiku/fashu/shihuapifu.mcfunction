execute if score @s pingbi matches 0 run tellraw @a [{"selector":"@s"},{"text":"使用了","color":"gold"},{"text":"[石化皮肤]","color":"dark_purple","hoverEvent":{"action":"show_text","value":"队伍玩家获得持续90s的额外生命20♥"}}]
