execute if score @s pingbi matches 0 run tellraw @a [{selector:"@s"},{translate: "game.yongpaiku.template.1",color:"gold"},{translate: "game.yongpaiku.fashu.shihuapifu.1",color:"dark_purple",hover_event:{action:"show_text","value":"队伍玩家获得持续90s的额外生命20♥"}}]
