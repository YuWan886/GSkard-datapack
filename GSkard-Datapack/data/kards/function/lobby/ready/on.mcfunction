...
tellraw @a [{selector:"@s"},{translate: "kards.function.lobby.ready.on.1", fallback: " 准备就绪 ",color:"green"},{translate: "kards.function.tick.2", fallback: "[",color:"gray"},{score:{name:"#system",objective:"Ready_Num"},color:"green"},{translate: "kards.function.game.ingame.general.2", fallback: "/",color:"gray"},{score:{name:"人数",objective:"p"},color:"gold"},{translate: "kards.function.tick.5", fallback: "]",color:"gray"}]
