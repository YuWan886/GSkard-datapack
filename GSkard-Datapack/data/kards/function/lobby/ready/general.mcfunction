item replace entity @a[tag=Un_Ready] container.4 with minecraft:blaze_rod[consumable={sound:{sound_id:"minecraft:block.beacon.activate"},consume_seconds:0,animation:"brush",has_consume_particles:false},custom_name={italic:false,text: "准备",color:"green",bold:true},custom_data={kards:'准备',lobby:'blaze'},use_cooldown={seconds:0.5f},item_model="ender_pearl"]
item replace entity @a[tag=Ready] container.4 with minecraft:blaze_rod[consumable={sound:{sound_id:"minecraft:block.beacon.deactivate"},consume_seconds:0,animation:"brush",has_consume_particles:false},custom_name={italic:false,text: "取消准备",color:"red",bold:true},custom_data={kards:'取消准备',lobby:'blaze'},enchantment_glint_override=true,use_cooldown={seconds:0.5f},item_model="ender_eye"]
...
execute if score #system GameStatus matches 0 run title @a[tag=Un_Ready] actionbar {text: "您将观战游戏",color:"red",bold:true}
