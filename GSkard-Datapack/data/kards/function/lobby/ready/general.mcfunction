...
execute as @a[advancements={kards:chengjiu/laodeng=true}] if score @s Ready matches 0 run item replace entity @s container.4 with minecraft:ender_pearl[item_name={text: "准备",color:"green",bold:true},custom_data={kards:'准备'},use_cooldown={seconds:0.5f}]
execute as @a[advancements={kards:chengjiu/laodeng=true}] if score @s Ready matches 1 run item replace entity @s container.4 with minecraft:ender_pearl[item_name={text: "取消准备",color:"red",bold:true},custom_data={kards:'取消准备'},enchantment_glint_override=true,use_cooldown={seconds:0.5f}]
