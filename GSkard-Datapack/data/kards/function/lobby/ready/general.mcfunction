...
execute if score system status matches 0 run title @a[tag=Un_Ready,advancements={kards:chengjiu/laodeng=true}] actionbar {translate: "lobby.ready.general.4",color:"red",bold:true}
