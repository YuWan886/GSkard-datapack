...
execute as @a if score @s wiki matches 1 run tellraw @s [{"text":"[点我打开GSkard神秘小链接~]","color":"gold","bold":true,"clickEvent":{"action":"open_url","value":"https://docs.qq.com/doc/DY0RiSmROZVRaRmRY"},"hoverEvent":{"action":"show_text","value":"地图介绍以及牌库大全"}}]
