...
execute as @a if score @s wiki matches 1 run tellraw @s [{text:"[点我打开GSkard神秘小链接~]",color:"gold",bold:true,click_event:{action:"open_url","url":"https://docs.qq.com/doc/DY0RiSmROZVRaRmRY"},hover_event:{action:"show_text",value:"地图介绍以及牌库大全"}}]
