...
execute unless entity @e[type=text_display,tag=map] run summon minecraft:text_display 83 226.7 -35 {billboard:vertical,translate: 'kards.function.lobby.setting.map.general.1', fallback: '§6点我切换至下一张地图',Tags:["map"]}
