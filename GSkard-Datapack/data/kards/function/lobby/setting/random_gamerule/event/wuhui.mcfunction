...
tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.1281", fallback: "所有人只能抽取到",color:"gray",bold:true},{translate: "json.kards.dialog.setting.random_start.main.1292", fallback: "[舞王僵尸]",color:"dark_green",bold:true}]
tellraw @a [{"text":"\n======——-——======\n","color":"gray"}]
