...
tellraw @a [{translate: "json.kards.dialog.setting.random_start.main.855", fallback: "所有人默认使用",color:"gray",bold:true},{translate: "json.kards.dialog.setting.random_start.main.876", fallback: "[贪欲魔盒]",color:"white",bold:true}]
tellraw @a [{"text":"\n======——-——======\n","color":"gray"}]
