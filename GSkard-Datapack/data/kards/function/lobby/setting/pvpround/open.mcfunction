...
tellraw @a [{translate: "lobby.setting.choupai.11and15.1.1",color: "gold"},{translate: "lobby.setting.pvpround.off.1",color: "aqua"},{translate: "lobby.setting.pvpround.open.1",color: "green"}]
execute as @a at @s run playsound minecraft:block.amethyst_block.hit player @s ~ ~ ~ 100 2
setblock 100 228 -23 air
setblock 100 228 -23 minecraft:oak_wall_sign[facing=north]{front_text:{messages:[{click_event:{action:"run_command",command:"/function kards:lobby/setting/pvpround/off"},color:"aqua",translate: "lobby.setting.pvpround.off.1"},{translate: "lobby.setting.pvpround.open.2",color:"green"},{translate: "lobby.setting.choupai.11and15.4.2",color:"gray"},'']}} destroy
...
execute as @a at @s run playsound minecraft:block.amethyst_block.hit player @s ~ ~ ~ 100 2
setblock 101 228 -23 minecraft:oak_wall_sign[facing=north]{front_text:{messages:[{click_event:{action:"run_command",command:"/function kards:lobby/setting/roundcount/30"},color:"gold",translate: "lobby.setting.pvpround.open.3"},{translate: "lobby.setting.pvpround.open.5",color:"green"},{translate: "lobby.setting.choupai.11and15.4.2",color:"gray"},'']}} destroy
...
setblock 101 227 -23 minecraft:oak_wall_sign[facing=north]{front_text:{messages:[{color:"gold",translate: "lobby.setting.pvpround.open.8"},{translate: "lobby.setting.pvpround.open.9",color:"green"},{translate: "lobby.setting.pvpround.open.10",color:"gray"},'']}} destroy
