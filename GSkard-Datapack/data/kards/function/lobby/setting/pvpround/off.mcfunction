...
tellraw @a [{translate: "kards.function.lobby.setting.choupai.11and15.1.1", fallback: "提示:",color: "gold"},{translate: "kards.function.lobby.setting.pvpround.off.1", fallback: "PVP回合",color: "aqua"},{translate: "kards.function.lobby.setting.pvpround.off.2", fallback: " 已禁用!",color: "red"}]
execute as @a at @s run playsound minecraft:block.amethyst_block.hit player @s ~ ~ ~ 100 2
setblock 100 228 -23 air
setblock 100 228 -23 minecraft:oak_wall_sign[facing=north]{front_text:{messages:[{click_event:{action:"run_command",command:"/function kards:lobby/setting/pvpround/open"},color:"aqua",translate: "kards.function.lobby.setting.pvpround.off.1", fallback: "PVP回合"},{translate: "kards.function.lobby.setting.pvpround.off.3", fallback: "禁用",color:"red"},'','']}} replace
