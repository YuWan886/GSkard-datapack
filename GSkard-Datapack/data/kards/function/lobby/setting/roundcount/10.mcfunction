...
setblock 61 227 -11 minecraft:oak_wall_sign[facing=east]{front_text:{messages:[{click_event:{action:"run_command",command:"/function kards:lobby/setting/roundcount/20"},color:"gold",text:"PVP回合设置为"},{text:"10",color:"green"},"",""]}} replace
