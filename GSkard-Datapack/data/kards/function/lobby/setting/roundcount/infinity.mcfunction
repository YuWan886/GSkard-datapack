...
setblock 61 227 -11 minecraft:oak_wall_sign[facing=east]{front_text:{messages:[{color:"gold",translate: "lobby.setting.pvpround.open.3"},{translate: "lobby.setting.pvpround.off.3",color:"red"},{translate: "lobby.setting.roundcount.infinity.2",color:"red"},'""']}} destroy
