...
setblock 95 228 -29 minecraft:oak_wall_sign[facing=south]{front_text:{messages:[{click_event:{action:"run_command",command:"/function kards:lobby/setting/choupai/1and5/3"},color:"gold",translate: "lobby.setting.choupai.1and5.1.2"},{translate: "lobby.setting.choupai.11and15.2.1",color:"green"},{translate: "lobby.setting.choupai.11and15.4.2",color:"gray"},'']}} replace