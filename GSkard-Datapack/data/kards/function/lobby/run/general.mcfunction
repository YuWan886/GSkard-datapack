...
execute as @a[tag=Running] if score @s RunningTime_Min matches 0 if score @s RunningTime_Sec matches ..9 run title @s actionbar [{text: "00",color:"green"},{text: ".0",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]
execute as @a[tag=Running] if score @s RunningTime_Min matches 0 if score @s RunningTime_Sec matches 10.. run title @s actionbar [{text: "00",color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]

execute as @a[tag=Running] if score @s RunningTime_Min matches ..9 if score @s RunningTime_Sec matches ..9 run title @s actionbar [{text: "0",color:"green"},{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{text: ".0",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]
execute as @a[tag=Running] if score @s RunningTime_Min matches ..9 if score @s RunningTime_Sec matches 10.. run title @s actionbar [{text: "0",color:"green"},{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]

execute as @a[tag=Running] if score @s RunningTime_Min matches 10.. if score @s RunningTime_Sec matches ..9 run title @s actionbar [{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{text: ".0",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]
execute as @a[tag=Running] if score @s RunningTime_Min matches 10.. if score @s RunningTime_Sec matches 10.. run title @s actionbar [{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{text: ".",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]