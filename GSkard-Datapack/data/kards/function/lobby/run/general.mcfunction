...
execute as @a[tag=Running] if score @s RunningTime_Min matches ..9 if score @s RunningTime_Sec matches ..9 run title @s actionbar [{translate: "lobby.run.finishes.4",color:"green"},{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{translate: "lobby.run.finishes.2",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{translate: "lobby.run.finishes.3",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]
execute as @a[tag=Running] if score @s RunningTime_Min matches ..9 if score @s RunningTime_Sec matches 10.. run title @s actionbar [{translate: "lobby.run.finishes.4",color:"green"},{score:{name:"@s",objective:"RunningTime_Min"},color:"green"},{translate: "lobby.run.finishes.3",color:"green"},{score:{name:"@s",objective:"RunningTime_Sec"},color:"green"},{translate: "lobby.run.finishes.3",color:"green"},{score:{name:"@s",objective:"RunningTime_Tick"},color:"green"}]
