...
execute if score @s[type=player] enchantment_chance_temp matches 1..10 run tag @s add DongJie
execute if score @s[type=player] enchantment_chance_temp matches 1..10 run scoreboard players add @s DongJie 50

execute if score @s[type=!player] enchantment_chance_temp matches 1..50 run tag @s add DongJie
