...
execute on attacker if items entity @s weapon.mainhand *[enchantments~[{enchantments:'kards:liansuo',levels:{min:5}}]] run scoreboard players set @s enchantment_liansuo 6

execute on attacker store result storage enchantment_liansuo_damage damage double 2 run attribute @s attack_damage get
