...
tellraw @s [{translate: "music.kards.1",color: "green"},{translate: "music.kards.2",color: "gold"},{translate: "music.kards.3",color: "gray"},{translate: "music.kards.1",color: "green"}]