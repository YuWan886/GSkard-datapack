...
effect clear @s
team join First @s
tellraw @a [{selector:"@s"},{translate: "kards.function.advancement.first_join_game.1", fallback: "达成了进度",color:"white"},{translate: "kards.function.advancement.first_join_game.2", fallback: "[你管这叫卡牌对战?]",color:"green",hover_event:{action:"show_text",value:{translate: "kards.function.advancement.first_join_game.3", fallback: "你管这叫卡牌对战?\n首次进入GSkard",color:"green"}}}]
