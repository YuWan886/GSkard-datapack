...
team leave @s
tellraw @s [{translate: "kards.function.leave_game.not_ingame.1", fallback: "欢迎老登",color:"gold"},{selector:"@s",color:"white"},{translate: "kards.function.leave_game.not_ingame.2", fallback: "再次进入游戏",color:"gold"}]
