...
execute if entity @e[dy=1.5,tag=!G36K_Shoot] run scoreboard players set @s G36K_Ray -1

execute if score @s G36K_Ray matches -1 run damage @n[distance=..3] 1 arrow by @p[tag=G36K_Shoot]
